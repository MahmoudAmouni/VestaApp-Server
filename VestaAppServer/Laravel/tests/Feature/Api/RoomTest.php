...
class RoomTest extends TestCase
{
    ...
    public function test_can_turn_all_devices_off_successfully()
    {
        $user = User::factory()->create(['role_id' => 1]);
        $home = Home::create([
            'name' => 'Test Home',
        ...
        $response = $this->actingAs($user, 'api')
            ->postJson("/api/v1/room/{$home->id}/{$room->id}/off");
    ...
    public function test_fails_to_turn_all_devices_off_for_non_existent_room()
    {
        $user = User::factory()->create(['role_id' => 1]);
        $home = Home::create([
            'name' => 'Test Home',
        ...
        $response = $this->actingAs($user, 'api')
            ->postJson("/api/v1/room/{$home->id}/99999/off");
